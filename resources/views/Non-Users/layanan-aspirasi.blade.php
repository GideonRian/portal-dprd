    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
                Suara Anda adalah prioritas kami. Sampaikan aspirasi, saran, atau keluhan untuk pembangunan Tapanuli Selatan
                yang lebih baik.
            </p>
        </div>
        ...
        <div class="flex justify-center mb-10">
            <div class="bg-white p-1 rounded-xl shadow-sm border border-gray-200 inline-flex">
                <a href="{{ route('layanan.aspirasi') }}"
                    class="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-semibold text-sm flex items-center gap-2 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            <div
                class="bg-blue-600 rounded-xl p-5 text-white shadow-md transform hover:-translate-y-1 transition duration-300">
            ...
            <div
                class="bg-[#10b981] rounded-xl p-5 text-white shadow-md transform hover:-translate-y-1 transition duration-300">
            ...
            <div
                class="bg-[#a855f7] rounded-xl p-5 text-white shadow-md transform hover:-translate-y-1 transition duration-300">
        ...
        @if (session('success'))
            <div class="bg-[#16a34a] rounded-2xl p-6 md:p-8 text-white mb-10 shadow-lg animate-fade-in-down">
                <div class="flex items-start gap-4 mb-5">
                    <div
                        class="w-8 h-8 rounded-full border-2 border-white flex items-center justify-center flex-shrink-0 mt-0.5">
                        <i class="fa-solid fa-check text-sm"></i>
                    </div>
                    <div>
                        <h2 class="text-xl md:text-2xl font-bold mb-1">Aspirasi Berhasil Dikirim!</h2>
                        <p class="text-green-100 text-sm leading-relaxed">Terima kasih atas partisipasi Anda. Tim kami akan
                            meninjau dan menindaklanjuti aspirasi Anda sesegera mungkin.</p>
                    </div>
                </div>
                ...
                <div class="bg-white/20 rounded-xl p-5 border border-white/20 backdrop-blur-sm">
                    ...
                    <p class="text-2xl md:text-3xl font-mono font-bold tracking-widest mb-2 drop-shadow-sm">
                        {{ session('tracking_code') }}</p>
                    <p class="text-xs text-green-100">Simpan kode ini untuk melacak status laporan Anda. Klik tab "Lacak
                        Status" untuk melihat perkembangan.</p>
                </div>
            </div>
        @endif
            ...
            <div class="p-8">
                @if ($errors->any())
                    <div class="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 mb-6 rounded-r-lg shadow-sm">
                        <p class="font-bold mb-2"><i class="fa-solid fa-triangle-exclamation"></i> Gagal Mengirim Aspirasi.
                            Periksa isian berikut:</p>
                ...
                <form action="{{ route('aspirasi.kirim') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-6">
                            <span
                                class="flex items-center justify-center w-6 h-6 rounded-md bg-blue-100 text-blue-600 font-bold text-sm">1</span>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-6">
                            <span
                                class="flex items-center justify-center w-6 h-6 rounded-md bg-blue-100 text-blue-600 font-bold text-sm">2</span>
                            <h3 class="font-bold text-gray-900 text-lg">Detail Aspirasi</h3>
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-3">Kategori <span
                                    class="text-red-500">*</span></label>
                                ...
                                @foreach ($kategori as $kat)
                                    <label class="cursor-pointer relative">
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="text-[10px] md:text-xs text-gray-600 font-medium leading-tight">{{ $kat['label'] }}</span>
                                        </div>
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Isi Aspirasi <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="mb-6 p-5 bg-blue-50 border border-blue-100 rounded-xl">
                            <label class="block text-sm font-bold text-gray-800 mb-1">Lokasi Kejadian (TKP) <span
                                    class="text-red-500">*</span></label>
                            <p class="text-xs text-gray-600 mb-4">Mohon izinkan akses lokasi pada browser Anda agar kami
                                dapat memvalidasi titik pasti laporan ini.</p>

                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                <button type="button" id="btn_lokasi"
                                    class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition shadow-sm flex items-center gap-2 whitespace-nowrap">
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-100">
                        <button type="reset"
                            class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium text-sm hover:bg-gray-50 transition">
                            Reset Form
                        </button>
                        <button type="submit"
                            class="px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium text-sm hover:bg-blue-700 transition shadow-md flex items-center gap-2">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="space-y-6">
                <div class="flex gap-4">
                    ...
                    <div>
                        <h4 class="font-bold text-sm text-gray-900 mb-1">Berapa lama aspirasi saya akan ditindaklanjuti?
                        </h4>
                        <p class="text-sm text-gray-600 leading-relaxed">Setiap aspirasi akan ditinjau dan ditindaklanjuti
                            maksimal 14 hari kerja sejak diterima oleh DPRD Tapanuli Selatan.</p>
                    </div>
                </div>
                <div class="flex gap-4">
                    <div class="flex-shrink-0 mt-1">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">Ya, semua data pribadi dan aspirasi Anda dijamin
                            kerahasiaannya sesuai dengan peraturan perundang-undangan yang berlaku.</p>
                    </div>
                </div>
                <div class="flex gap-4">
                    <div class="flex-shrink-0 mt-1">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">Setelah mengirim aspirasi, Anda akan menerima kode
                            tracking unik. Gunakan kode tersebut di tab "Lacak Status" untuk melihat perkembangan aspirasi
                        ...
                        navigator.geolocation.getCurrentPosition(
                            function(position) {
                                ...
                                inputKoordinat.value =
                                    `Titik Valid: ${lat.toFixed(6)}, ${lng.toFixed(6)}`;
                                inputLat.value = lat;
                                inputLng.value = lng;

                                inputKoordinat.classList.remove('text-gray-500', 'placeholder-red-400');
                                inputKoordinat.classList.add('text-green-700', 'font-bold',
                                    'border-green-300', 'bg-green-50');

                                btnLokasi.innerHTML =
                                    '<i class="fa-solid fa-check"></i> Lokasi Diperbarui';
                            ...
                            function(error) {
                                ...
                                if (error.code === error.PERMISSION_DENIED) {
                                    errorMessage =
                                        "Anda menolak akses lokasi. Harap izinkan lokasi di pengaturan browser untuk mengirim form ini.";
                                }
                                alert(errorMessage);

                                btnLokasi.innerHTML =
                                    '<i class="fa-solid fa-location-crosshairs"></i> Coba Lagi';
                                btnLokasi.classList.remove('opacity-75', 'cursor-not-allowed');
