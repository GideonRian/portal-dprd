...
<head>
    ...
    <title>Tambah Anggota - DPRD Tapanuli Selatan</title>
    ...
    <main class="w-full px-4 sm:px-6 lg:px-8 py-8 max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-gray-500 font-medium text-sm">Isi data anggota baru</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('staff.anggota.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama" required placeholder="Contoh: Ir. Budi Santoso, M.Si"
                ...
                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Jabatan <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="jabatan" required placeholder="Contoh: Ketua DPRD"
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Partai/Fraksi <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="partai" required placeholder="Contoh: Partai A"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Komisi <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="komisi" required placeholder="Contoh: Komisi I"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Daerah Pemilihan <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="dapil" required placeholder="Contoh: Tapsel I"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            <select name="badan"
                                ...
                                <option value="Badan Pembentukan Peraturan Daerah (Bapemperda)">Badan Pembentukan
                                    Peraturan Daerah (Bapemperda)</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="text" name="telepon" placeholder="Contoh: (061) 123-4567"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Email</label>
                        <input type="email" name="email" placeholder="Contoh: nama@dprd-tapsel.go.id"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                </div>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-regular fa-floppy-disk"></i> Tambah Anggota
                    </button>
                </div>
            </form>
        </div>
