    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full px-4">
        ...
        <div
            ...
            <form action="{{ route('staff.login.process') }}" method="POST">
                ...
                {{-- Pesan Sukses (Misal: Berhasil Logout) --}}
                @if (session('success'))
                    <div
                ...
                {{-- Pesan Error (Dari session biasa ATAU dari Auth Error Validation) --}}
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        {{-- Tambahan value="{{ old('username') }}" agar tidak perlu mengetik ulang jika password salah --}}
                ...
                <button type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl transition duration-300 shadow-lg shadow-blue-900/50 flex items-center justify-center gap-2">
