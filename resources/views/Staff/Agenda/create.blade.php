    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-10 max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            <div class="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center text-white shadow-md"><i
                    class="fa-regular fa-calendar-plus text-xl"></i></div>
            <div>
                <h2 class="text-3xl font-extrabold text-gray-900 mb-1">Tambah Agenda Baru</h2>
                <p class="text-gray-500 text-sm">Buat jadwal kegiatan baru untuk DPRD</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            <form action="{{ route('staff.agenda.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="judul" required placeholder="Contoh: Rapat Paripurna Pembahasan APBD 2027"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Waktu <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="waktu" required placeholder="09:00 - 12:00 WIB"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 outline-none">
                    </div>
                    <div>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Lokasi <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="lokasi" required placeholder="Contoh: Ruang Rapat Paripurna"
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 outline-none">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Peserta <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="peserta" required placeholder="Contoh: Seluruh Anggota DPRD"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 outline-none">
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-xs text-gray-400 mt-2" id="hint-gambar">Format: JPG, PNG. Maksimal 2MB.</p>
                </div>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-regular fa-calendar-check"></i> Tambah Agenda
                    </button>
                </div>
            </form>
        </div>
